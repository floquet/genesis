...
% CLI: pdflatex main-RaVThOughT.tex
% Beamer likes biber
\documentclass[10pt, oneside]{article}

% Created by ./../scripts/new-doc.sh at 2024-12-26 07:50:07
...
\newcommand{\pGithub}                                           {\HomePath/GitHub/}
    \newcommand{\pTrunk}	                                       {\pGithub/genesis/}
        \newcommand{\pPres}                                     {\pTrunk/docs/}
            \newcommand{\pWorkspace}                        {\pPres/RaVThOughT}
...
\addbibresource{\pBibs/RaVThOughT.bib}
