...
% Beamer presentation template for $PROJECT_NAME; created $(date)
...
\input{\pGlobalConfigPres/"config-pres.tex"}
...
new_step "append main Beamer file"
cat << \EOF >> "$PROJECT_DIR/main/main-${PROJECT_NAME}.tex"
%   --   --   --   --   --   --   --   --   --   -- Bibliography
...
new_step "Seed introduction section"
...
new_step "Seed local configuration $LOCAL_CONFIG_FILE"
